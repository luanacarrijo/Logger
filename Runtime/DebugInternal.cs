...
// stolen from https://github.com/JoebRogers/UnityDebug
namespace Mirtilo.Logger
{
    public static class DebugInternal
    {
        ...
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR"), Conditional("UNITY_ASSERTIONS")]
        public static void LogAssertionFormat(Object context, string format, bool condition = true,
            params object[] args)
        {
            if (condition)
            {
